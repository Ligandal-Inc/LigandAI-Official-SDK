...
- API-key validation: ``server/internal-routes.ts:41``
- Tier features: ``server/internal-routes.ts`` and ``server/routes.ts``
- Generation:    ``server/routes.ts:tierLimits``
- Fold limits:   ``server/internal-routes.ts:TIER_GPU_CAP``
"""
